...
export default function ComingSoon({ pageKey }) {
  ...
  const PAGE_NAMES = {
    en: {
about:       'About Us',
      aboutMinistryOverview: 'Secretariat Overview',
      ...
      aboutDeputySecretary: 'About Deputy Secretary',
      contact:     'Contact Us',
    ...
    si: {
      about:       'අප ගැන',
      aboutMinistryOverview: 'කාර්යාලය පිළිබඳ සාරාංශය',
      ...
      aboutDeputySecretary: 'නියෝජ්‍ය ලේකම් පිළිබඳව',
      contact:     'අප අමතන්න',
      departments: 'අංශ',
      documents:   'ලේඛන',
    ...
    ta: {
      ...
      aboutMinistryOverview: 'செயலகத்தின் அறிமுகம்',
      ...
      aboutDeputySecretary: 'துணை செயலாளர் பற்றி',
      ...
      <div style={{ position: 'relative', zIndex: 1, textAlign: 'center', maxWidth: 580 }}>
        ...
        <motion.p variants={floatUp(0.28)} initial="hidden" animate="visible"
          style={{
            ...
            fontSize: 'clamp(1rem, 1.6vw, 1.13rem)',
            color: '#5A2030',
            opacity: 0.78,
            lineHeight: 1.9,
        ...
        {/* Contact info */}
        <motion.div variants={floatUp(0.33)} initial="hidden" animate="visible"
          style={{
          ...
          <a href="tel:+94912234503" style={{
            ...
            fontSize: '0.92rem', fontFamily: 'Inter, sans-serif', fontWeight: 500,
            color: MAROON, textDecoration: 'none', opacity: 0.8,
          }}>
        ...
        {/* Buttons */}
        <motion.div variants={floatUp(0.44)} initial="hidden" animate="visible"
