...
const uploadsRouter      = require('./features/portal/routes/uploads')
const staffRouter        = require('./features/portal/routes/staff')
const faqsRouter         = require('./features/portal/routes/faqs')
const homeContentRouter  = require('./features/portal/routes/homeContent')
const departmentsRouter  = require('./features/portal/routes/departments')
const siteSettingsRouter = require('./features/portal/routes/siteSettings')
const aboutOverviewRouter  = require('./features/portal/routes/aboutOverview')
const aboutFunctionsRouter = require('./features/portal/routes/aboutFunctions')
const orgStructureRouter   = require('./features/portal/routes/orgStructure')
const aboutHistoryRouter   = require('./features/portal/routes/aboutHistory')
...
app.use('/api/about-overview',  aboutOverviewRouter)
app.use('/api/about-functions', aboutFunctionsRouter)
app.use('/api/org-structure',   orgStructureRouter)
app.use('/api/about-history',   aboutHistoryRouter)
